...
void GPIO_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC |
	...
	/** @start SIMSEL GPIO init @vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv**/
	GPIO_InitStruct.GPIO_Pin = SIMSEL_PIN;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(SIMSEL_PORT, &GPIO_InitStruct);
	
	/** @start TEST GPIO init @vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv**/
	GPIO_InitStruct.GPIO_Pin = TEST_PIN;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IPU;
	GPIO_Init(TEST_PORT, &GPIO_InitStruct);
	
	/** @start TAMPER GPIO init @vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv**/
